      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col justify-center">
          ...
          >
            ...
            <span className="font-mono text-[#b45555] tracking-widest uppercase text-sm">
              Who I am
            </span>
          </motion.div>
          ...
          >
            <p>
              I am a{" "}
              <strong className="text-white">Full Stack Developer</strong> based
              in Bangladesh, with a passion for building digital services/stuff
              I want. I have a knack for all things launching products, from
            ...
            <p>
              ...
              playing video games, or exploring new technologies to keep my
              skills sharp.
            </p>
          </motion.div>
          ...
          >
            {stats.map((stat, i) => (
              <div
                key={i}
                className="bg-[#111] border border-[#222] p-4 rounded-xl flex flex-col items-center text-center group hover:border-[#b45555] transition-colors"
              >
                <stat.icon className="text-[#b45555] text-2xl mb-2 group-hover:text-[#b45555] transition-colors" />
                <h4 className="font-space text-2xl md:text-3xl font-bold text-white/80">
                  {stat.value}
                </h4>
          ...
          >
            <a
              ...
              className="group relative px-8 py-4 bg-[#491717] text-white font-space font-bold uppercase tracking-widest rounded-lg overflow-hidden shadow-[0_0_20px_rgba(73,23,23,0.4)] hover:shadow-[0_0_30px_rgba(73,23,23,0.6)] transition-all inline-flex items-center gap-3 cursor-pointer"
            >
