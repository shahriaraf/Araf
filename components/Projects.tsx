                            ...
                            <div className="h-[35%] p-6 md:p-8 flex flex-col justify-between bg-gradient-to-b from-[#050505] to-[#1a0505]">
                                ...
                                <div className="flex justify-between items-center mt-4 pt-4 border-t border-[#491717]/30">
                                    <div className="flex gap-5">
                                        ...
                                        {activeTab === 'web' ? (
                                            <a href={project.liveLink} target="_blank" className="text-[#ff5555] hover:text-white transition-colors" title="Live Site"><FaExternalLinkAlt size={22} /></a>
                                        ) : (
                                            <a href={project.apkLink} className="text-[#ff5555] hover:text-white transition-colors" title="Download"><FaAndroid size={24} /></a>
                                        )}
                                    </div>
